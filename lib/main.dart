    ...
    return MaterialApp(
      ...
      builder: (context,child){
        ...
        return Theme(data: ThemeData(
          ...
          tabBarTheme: TabBarTheme(labelColor:Colors.white,unselectedLabelColor: Colors.blueGrey[300],), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: Colors.blueGrey),), child: const HomePage());
      },
    );
  }
